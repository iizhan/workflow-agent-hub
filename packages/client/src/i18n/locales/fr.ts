export default {
  // Login
  login: {
    title: 'Connexion a l’espace de travail',
  ...
  chat: {
    ...
    emptyState: 'Demarrer une conversation avec l’assistant',
    ...
    sessionScopeHint: 'Le chat affiche uniquement les sessions du workspace et de l’API. Les sessions CLI, Telegram, Discord, Cron et autres canaux sont en lecture seule dans Historique.',
    openHistory: 'Ouvrir l’historique',
    hermesHistory: 'Historique d’exécution',
    historyScopeHint: 'Sessions d’historique d’exécution en lecture seule, regroupées par source.',
...
jobTriggered: 'Job declenche',
  ...
  models: {
    ...
    copilotAddDetected: 'Un token OAuth GitHub Copilot a été détecté sur cette machine. Cliquez sur Ajouter pour activer Copilot dans le workspace actuel.',
    ...
    copilotDeleteHintGhCli: 'Copilot sera masqué dans ce workspace. Votre connexion gh CLI n\'est pas affectée — `gh auth status` indiquera toujours que vous êtes connecté.',
    copilotDeleteHintAppsJson: 'Copilot sera masqué dans ce workspace. Votre extension Copilot de VS Code reste connectée.',
  ...
  changelog: {
    ...
    new_0_5_15_9: 'Correction rendu média du workspace et retry synchronisation',
