export default {
  ...
  chat: {
    ...
    sessions: 'セッション',
    webUiSessions: 'セッション',
    sessionScopeHint: 'チャットにはワークスペースと API のセッションのみ表示されます。CLI、Telegram、Discord、Cron などのチャンネルセッションは履歴で読み取り専用として表示されます。',
    openHistory: '履歴を開く',
    hermesHistory: 'ランタイム履歴',
    historyScopeHint: 'ソース別にグループ化された ランタイム履歴セッションを読み取り専用で表示します。',
  ...
  models: {
    ...
    copilotAddDetected: 'このマシンで GitHub Copilot OAuth トークンを検出しました。「追加」をクリックして 現在のワークスペースで Copilot を有効化します。',
    ...
    copilotDeleteHintGhCli: 'Copilot は現在のワークスペースで非表示になります。gh CLI のログインには影響しません — `gh auth status` は引き続きログイン状態を表示します。',
    copilotDeleteHintAppsJson: 'Copilot は現在のワークスペースで非表示になります。VS Code Copilot 拡張機能のログインには影響しません。',
    customBadge: 'カスタム',
    previewBadge: 'プレビュー',
    disabledBadge: '利用不可',
  ...
  changelog: {
    ...
    new_0_5_15_9: 'ワークスペース Markdown メディアレンダリングと同期リトライを修正',
    ...
    new_0_5_5_2: 'ランタイムセッション履歴ページを追加',
