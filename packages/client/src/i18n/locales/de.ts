export default {
  ...
  chat: {
    ...
    emptyState: 'Starten Sie eine Konversation mit dem Assistenten',
    ...
    hermesHistory: 'Laufzeitverlauf',
    historyScopeHint: 'Schreibgeschützte Laufzeitverlaufssitzungen, nach Quelle gruppiert.',
...
jobTriggered: 'Job ausgelost',
  ...
  models: {
    ...
    copilotAddDetected: 'Auf diesem Rechner wurde ein GitHub Copilot OAuth-Token erkannt. Klicken Sie auf „Hinzufügen", um Copilot im aktuellen Workspace zu aktivieren.',
    ...
    copilotDeleteHintGhCli: 'Copilot wird in diesem Workspace ausgeblendet. Ihre gh CLI-Anmeldung bleibt erhalten — `gh auth status` zeigt weiterhin als angemeldet.',
    copilotDeleteHintAppsJson: 'Copilot wird in diesem Workspace ausgeblendet. Ihre VS Code Copilot-Erweiterung bleibt angemeldet.',
  ...
  changelog: {
    ...
    new_0_5_15_9: 'Workspace-Markdown-Medien-Rendering und Sync-Wiederholung korrigiert',
    ...
    new_0_5_5_2: 'Verlaufsseite für Laufzeit-Sitzungshistorie hinzugefügt',
