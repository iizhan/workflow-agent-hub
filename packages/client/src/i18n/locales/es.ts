export default {
  // Login
  login: {
    title: 'Inicio de sesion del espacio de trabajo',
  ...
  chat: {
    ...
    emptyState: 'Inicia una conversacion con el asistente',
    ...
    sessionScopeHint: 'Chat solo muestra sesiones del workspace y la API. Las sesiones de CLI, Telegram, Discord, Cron y otros canales son de solo lectura en Historial.',
    openHistory: 'Abrir historial',
    hermesHistory: 'Historial de ejecución',
    historyScopeHint: 'Sesiones del historial de ejecución, de solo lectura y agrupadas por origen.',
...
jobTriggered: 'Job ejecutado',
  ...
  models: {
    ...
    copilotAddDetected: 'Se detectó un token OAuth de GitHub Copilot en este equipo. Haz clic en Agregar para habilitar Copilot en el workspace actual.',
    ...
    copilotDeleteHintGhCli: 'Copilot se ocultará de este workspace. Tu sesión de gh CLI no se verá afectada — `gh auth status` seguirá mostrando que estás conectado.',
    copilotDeleteHintAppsJson: 'Copilot se ocultará de este workspace. La extensión Copilot de VS Code seguirá conectada.',
  ...
  changelog: {
    ...
    new_0_5_15_9: 'Corregido renderizado de medios del workspace y reintento de sincronización',
    ...
    new_0_5_5_2: 'Añadida página de historial para sesiones de ejecución',
    ...
    new_0_5_4_4: 'Fix web terminal runtime CLI availability after Docker deployment',
    ...
    new_0_5_4_7: 'Align usage analytics with runtime state DB schema',
